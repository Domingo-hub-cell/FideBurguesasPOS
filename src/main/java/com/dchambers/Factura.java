...
public class Factura {
    ...
    public void calcularTotales() {
        try {
            ...
            subtotal = impuesto = total = 0;
        }
    }

    public String generarArchivoFactura() {
    ...
    public String mostrarFactura() {
        ...
        for (Producto p : orden.getListaProductos())
            sb.append(" - ").append(p.getNombre()).append("  ₡").append(String.format("%,.2f", p.calcularPrecio())).append("\n");
