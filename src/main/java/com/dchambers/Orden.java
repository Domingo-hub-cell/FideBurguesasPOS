...
public class Orden {
    ...
    public void cambiarEstado(String estado) { this.estado = estado; }
    ...
    @Override public String toString() { return "Orden #" + idOrden + " - " + cliente + " - " + estado + " - " + fecha.format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm")); }
}
